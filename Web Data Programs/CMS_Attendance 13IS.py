...
if os.name == "nt":
    ...
    dataPath = "C:\\Users\\Akshay L Aradhya\\AppData\\Local\\Google\\Chrome\\User Data\\Testing 13IS"
...
try:
    ...
    cursor.execute("SELECT * FROM `Users`  WHERE USN LIKE '%13IS%'  ORDER BY `USN` ")
